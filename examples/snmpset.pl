...
# $Id: snmpset.pl,v 2.2 2003/05/06 11:00:46 dtown Exp $
...
use Net::SNMP 4.1.0 qw(:asn1 DEBUG_ALL);
use Getopt::Std;
...
Valid type values:
          a - IpAddress         o - OBJECT IDENTIFIER
          c - Counter           p - Opaque
          C - Counter64         s - OCTET STRING
          g - Gauge             t - TimeTicks
          i - INTEGER           h - OCTET STRING (hex)
USAGE
   exit 1;
}
